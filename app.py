...
# _lsj_concept_lookup / _format_lsj_context are used by ai_search (still in app.py);
# they move to the AI module's own import in the final extraction step.
from views_lsj import bp as lsj_bp, _lsj_concept_lookup, _format_lsj_context
