# V9 PILE — candidate items for the next engine wording (V9)

Established 2026-07-10 at the step-5 close (JP approval with the KEEP + BOOK rulings).
V8 is the live engine (stamp `lexica:7ef8620328a9`, promoted 2026-07-10, G2665 control fire).

**Forward rule (reviewer-set):** CC adds a line here when a gate catch is RULED (not on
suspicion); the reviewer verifies the line against the ruling. An item becomes a V9 edit
candidate only under the multi-exhibit standard — one exhibit logs a watch, it does not
justify an edit.

Format: date · word · defect class · exhibit pointer · status.

- 2026-07-10 · G2665 καταπέτασμα · **exemplar-echo** (edit A's in-prompt illustration
  reproduced near-verbatim in output: "sacrificial… following the LXX use" shape) ·
  exhibit: step-5 draw 2 (rejected), audit doc STEP 5 entry · **fix known: strip edit A's
  illustration to bare constraint** — structural, will recur; rate on record 1-of-3 draws.
- 2026-07-10 · G2665 καταπέτασμα · **physical-details rule candidate** (concrete detail
...
- 2026-07-10 · G1244 διαιρέω + G1390 δόμα + G2168 εὐχαριστέω · **carve-invention —
  CONFIRMED V9 EDIT at FIVE instances (reviewer graduation ruling, banked 2026-07-10;
  banks forward, touches nothing in live V8):** διαιρέω d1 distribution-cluster split ·
  διαιρέω d3 1Co 12:11 solo shelf · δόμα d1 institutional super-shelf · δόμα d3 Ecc 5:1
  into a sense the verse contradicts · **G2168 build draw 1 (key 6b69615d) Rom 1:21 solo
  negation shelf, 0/10 floor attestation, #30 live catch, the purest #46 self-indicting
  instance yet ("The lemma's sense is unchanged" — a sense whose own definition denies
  it's a sense)** — each a carve or placement no floor draw attests. · **Edit basis =
  the direction on file: the drafter receives the floor's consensus carve as a
  CONSTRAINT, not merely as a diff-target after the fact.** · exhibits: both park
  entries + the G2168 PARKED entry, audit doc.
...
- 2026-07-10 · G1390 δόμα · **fabricated reference (2Ch 19:10, digit-slid) — NO prompt
  ...
  wording item.
- 2026-07-10 · G2168 εὐχαριστέω · **factual-claims family — THIRD EXHIBIT, new mechanism:
  referent mis-resolution** (build draw 3 asserted "the gratitude is addressed to God,
  not to the people named" for Rom 16:4, whose stored text reads "to whom not I only
  give thanks" — thanks TO Prisca and Aquila; draw 2 misfiled the same verse the same
  way: the parenthetical "to whom" resolves across the verse boundary to 16:3 and the
