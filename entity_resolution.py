...
# R-2 binder variant batch (2026-07-24): 206 hand-dispositioned KJV/LXX spellings ->
# ref-matched TIPNR entity heads. Verdict trail (per pair, incl. the 27 kills):
# docs/tickets/variant_batch_binder_verdicts.txt. Bind standard: target entity's own
# reference list contains the attested verse (checked via THIS module's parse). Safe by
# the number-guard: an entry only adds a fuzzy candidate; render still requires number
# agreement + verse in the entity's refs. Do NOT fold into the dict above by hand -
# the sub-batch labels (NEW-SESSION / R1-REVISIT) live in the verdicts file.
R2_BINDER_VARIANTS = {
    'abadon': 'abdon',
    'abia': 'abijah',
    'abiah': 'abijah',
    ...
    'berachah': 'beracah',
    'betharam': 'beth-haram',
    'bethhaccerem': 'beth-haccherem',
    'bethharan': 'beth-haram',
    'bethpalet': 'beth-pelet',
    'bethphelet': 'beth-pelet',
    'bethshan': 'beth-shean',
    'boseath': 'bozkath',
    'bosodeiah': 'besodeiah',
    'cain': 'kain',
    ...
    'mathan': 'mattan',
    'mathaniah': 'mattaniah',
    'matthaniah': 'mattaniah',
    'mekeziz': 'emek-keziz',
    'melchijah': 'malchijah',
    'melchiram': 'malchiram',
    'melchishua': 'malchi-shua',
    'meshellemiah': 'meshelemiah',
    'meshezabeel': 'meshezabel',
    'methusaela': 'methushael',
    'methuseleh': 'methuselah',
    'miamin': 'mijamin',
    'micah': 'mica',
    'milcha': 'milcah',
    'milchah': 'milcah',
    'mithridath': 'mithredath',
    'mizpar': 'mispar',
    'moan': 'maon',
    'naahshon': 'nahshon',
    'naammah': 'naamah',
    'naan': 'naam',
    'nabushasban': 'nebushazban',
    'nachon': 'nacon',
    'nahallel': 'nahalol',
    'nahari': 'naharai',
    'namuel': 'nemuel',
    ...
    'nashon': 'nahshon',
    'nathaneel': 'nethanel',
    'nergalsharezer': 'nergal-sar-ezer',
    'netopha': 'netophah',
    'netophathi': 'netophah',
    'odollam': 'adullam',
    'penuel': 'peniel',
    ...
    'salma': 'salmon',
    'samiah': 'samlah',
    'sanaballat': 'sanballat',
    'saraiah': 'seraiah',
    'saul': 'shaul',
    'secundos': 'secundus',
    'seriah': 'seraiah',
    'shahazinah': 'shahazumah',
    'shalitha': 'shalishah',
    'shammuah': 'shammua',
    'shearaiah': 'sheariah',
    'shelomith': 'shelomoth',
    ...
    'shemuel': 'samuel',
    'sherezar': 'sharezer',
    'shetharboznai': 'shethar-bozenai',
    'shihon': 'shion',
    'shimiramoth': 'shemiramoth',
    'shittin': 'shittim',
    'shochoh': 'socoh',
    'soccoth': 'succoth',
    'socho': 'soco',
...
VARIANT_ALIASES.update(R2_BINDER_VARIANTS)
